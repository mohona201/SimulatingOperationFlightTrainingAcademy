...
public class eligibilityController
{
    ...
    public void initialize() {
        ...
        studentIdColumn.setCellValueFactory(new TreeItemPropertyValueFactory<eligibility, String>("studentId"));
        studentNameColumn.setCellValueFactory(new TreeItemPropertyValueFactory<eligibility, String>("studentName"));
        eligibilityExamColumn.setCellValueFactory(new TreeItemPropertyValueFactory<eligibility, String>("examName"));
