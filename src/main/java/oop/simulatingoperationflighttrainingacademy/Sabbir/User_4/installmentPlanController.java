...
public class installmentPlanController
{
    ...
    @javafx.fxml.FXML
    private Button exportInstallmentSchedulePdfButton;
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    private Button markInstallmentOverdueButton;
    @javafx.fxml.FXML
    private TextField installmentStudentIdTextField;
    @javafx.fxml.FXML
    private ComboBox installmentPlanSelectComboBox;
    @javafx.fxml.FXML
    private TextField installmentPlanIdTextField;
    @javafx.fxml.FXML
    private ComboBox installmentFrequencyComboBox;
    @javafx.fxml.FXML
    private DatePicker installmentStartDatePicker;
    @javafx.fxml.FXML
    private ComboBox installmentFeeTypeComboBox;
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void exportInstallmentSchedulePdfOnActionButton(ActionEvent actionEvent) {
    }
    ...
    @javafx.fxml.FXML
    public void markInstallmentOverdueOnActionButton(ActionEvent actionEvent) {
    }
