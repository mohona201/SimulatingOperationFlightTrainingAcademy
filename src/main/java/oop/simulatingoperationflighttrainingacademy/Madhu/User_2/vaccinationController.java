...
public class vaccinationController
{
    ...
    @javafx.fxml.FXML
    private TableColumn administeredByTableColumn;
    @javafx.fxml.FXML
    private TextField vaccineNameTextField;
    @javafx.fxml.FXML
    private DatePicker vaccineDatePicker;
    @javafx.fxml.FXML
    private TableColumn vaccinationDateTableColumn;
    @javafx.fxml.FXML
    private TableColumn notesTableColumn;
    @javafx.fxml.FXML
    private TableView vaccinationHistoryTableView;
    @javafx.fxml.FXML
    private TextField studentNameTextField;
    @javafx.fxml.FXML
    private TableColumn vaccineNameTableColumn;
    @javafx.fxml.FXML
